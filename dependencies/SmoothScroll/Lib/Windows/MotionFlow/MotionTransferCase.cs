...
namespace Logitech.Windows.MotionFlow
{
  ...
  public abstract class MotionTransferCaseBase : MotionElement, IMotionTransferCase
  {
    ...
    public IMotionInfo MotionInfo { get { return this.First().MotionInfo; } }
    public double       Remainder { get { return this.Sum(item => item.Remainder); } }

    public bool Transfer(IMotionTarget target, object context) { return this.All(item => item.Transfer(target, context)); }
    #endregion
  ...
  public abstract class NativeMotionTransferCaseBase : ContentElement, INativeMotionTransferCase
  {
    ...
    public int NativeRemainder { get { return this.Sum(item => item.NativeRemainder); } }

    public bool Transfer(INativeMotionTarget target, object context) { return this.All(item => item.Transfer(target, context)); }
    #endregion
  ...
  public class MotionTransferCase : MotionTransferCaseBase
  {
    ...
    #region IEnumerable<INativeMotionTransfer>
    public override IEnumerator<IMotionTransfer> GetEnumerator() { return _items.GetEnumerator(); }
    #endregion
  }
  #endregion
  ...
  public class NativeMotionTransferCase : NativeMotionTransferCaseBase
  {
    ...
    #region IEnumerable<INativeMotionTransfer>
    public override IEnumerator<INativeMotionTransfer> GetEnumerator() { return _items.GetEnumerator(); }
    #endregion
  }
  #endregion
