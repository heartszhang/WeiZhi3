...
namespace Logitech.Windows.Input
{
  ...
  public class MouseWheelSingleShaftTransferCase : MouseWheelShaft, IMouseWheelTransferCase
  {
    ...
    #region IMouseWheelTransferCase
    public IMouseWheelShaft             ActiveShaft { get { return this; } set { if (value != this) throw new InvalidOperationException(); } }
    ...
    public IEnumerator<INativeMotionTransfer> GetEnumerator() { yield return this; }
    #endregion
  ...
  public class MouseWheelMultiShaftTransferCase : NativeCoupledMotionTransferCase, IMouseWheelTransferCase
  {
    ...
    #region Helpers
    private IOrderedEnumerable<int> DebouncingCellCountsOrderByDescending { get { return _debouncingFunctions.Keys.OrderByDescending(i => i); } }

    private int MatchDebouncingCellCount(double desiredCount) { return MatchDebouncingCellCount((int)Math.Round(desiredCount)); }
