...
namespace Logitech.Windows.Input
{
  ...
  public abstract class MouseWheelBehavior : IMouseWheelBehavior
  {
    ...
    public IMouseWheelController Controller { get { return Client.Controller; } }
    ...
    bool INativeMotionTarget.CanMove(IMotionInfo info, object context) { return true; }
    int  INativeMotionTarget.Coerce (IMotionInfo info, object context, int nativeDelta) { return nativeDelta; }
    void INativeMotionTarget.Move   (IMotionInfo info, object context, int nativeDelta) { (context as MouseWheelInputEventArgs).RaiseNativeEvent(nativeDelta); }
    #endregion

    #region IMotionSinkConverter
    public virtual double SinkToNormalized(double value) { return value / MotionIncrement; }
    public virtual double NormalizedToSink(double value) { return value * MotionIncrement; }
    #endregion

    #region Queries
    public IMouseWheelClient Client { get { return _client; } }
    #endregion
    ...
    #region Overridables
    protected virtual IMotionTarget MotionInput { get { return this; } }
    protected virtual double    MotionIncrement { get { return Client.MotionIncrement; } }

    protected virtual double CoerceSinkDelta(double sinkDelta) { return sinkDelta; }
    ...
    void OnWheelActiveTransferCaseChanged(object sender, EventArgs e) { InvalidateShaft(); }
    #endregion
  }
  #endregion
