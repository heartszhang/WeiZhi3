...
namespace Logitech.Maths
{
  ...
  public class LowPassFilter
  {
    ...
    public LowPassFilter(double lifetime) { Lifetime = lifetime; } 
    #endregion
    ...
    public double NextOutputDelta(double t, double dtMin)
    {
      ...
      Input = 0;
      //Debug.WriteLine("{5} = Lowpass.NextOutputDelat(t:{0},dtMin:{1}),dt:{2},_t0:{3},gain:{4},Lifetime:{6}"
      //    , t, dtMin, dt, _t0, gain, Output, Lifetime);
      return Output;
    }
    #endregion
  }
