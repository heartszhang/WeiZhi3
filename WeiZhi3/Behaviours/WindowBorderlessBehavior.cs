...
{
    public class WindowBorderlessBehavior : Behavior<Window>
    {
        public static DependencyProperty ResizeWithGripProperty = DependencyProperty.Register("ResizeWithGrip", typeof(bool), typeof(WindowBorderlessBehavior), new PropertyMetadata(true));
        public static DependencyProperty AutoSizeToContentProperty = DependencyProperty.Register("AutoSizeToContent", typeof(bool), typeof(WindowBorderlessBehavior), new PropertyMetadata(false));
